...
final class MaterialSearchBar extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _MaterialSearchBarState();
}

final class _MaterialSearchBarState extends State<MaterialSearchBar>
  ...
  @override
  void didUpdateWidget(covariant MaterialSearchBar oldWidget) {
  ...
  Widget build(BuildContext context) {
    final radius = BorderRadius.all(Radius.circular(64.r));
