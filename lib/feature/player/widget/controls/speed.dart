...
final class Speed extends StatelessWidget {
  ...
  Widget build(BuildContext context) => switch (AppPlatform.targetPlatform) {
    ...
    AppPlatforms.tizen => const _OneUiSpeed(),
    AppPlatforms.tvos => const _CupertinoSpeed(),
    AppPlatforms.webos => const _SandstoneSpeed(),
  };
}
...
final class _OneUiSpeed extends StatelessWidget {
  const _OneUiSpeed();
            ...
            child: SliderTheme(
              data: SliderTheme.of(context).copyWith(
                ...
                thumbShape: OneUiThumbShape(
                  thumbRadius: 8.s,
                  thickness: 1.s,
                  color: switch (state.speed.isFocused) {
                    true => Colors.white,
                    false => Colors.grey,
                  },
                ),
...
final class _SandstoneSpeed extends StatelessWidget {
  const _SandstoneSpeed();
          ...
          SizedBox(
            ...
            child: SliderTheme(
              data: SliderTheme.of(context).copyWith(
                ...
                thumbShape: switch (state.speed.isFocused) {
