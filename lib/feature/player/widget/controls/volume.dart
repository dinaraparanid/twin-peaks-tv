...
final class Volume extends StatelessWidget {
  ...
  Widget build(BuildContext context) => switch (AppPlatform.targetPlatform) {
    ...
    AppPlatforms.tizen => const _OneUiVolume(),
    AppPlatforms.tvos => const _CupertinoVolume(),
    AppPlatforms.webos => const _SandstoneVolume(),
  };
}
...
final class _OneUiVolume extends StatelessWidget {
  const _OneUiVolume();
            ...
            child: SliderTheme(
              data: SliderTheme.of(context).copyWith(
                ...
                thumbShape: OneUiThumbShape(
                  thumbRadius: 8.s,
                  thickness: 1.s,
                  color: switch (state.volume.isFocused) {
                    true => Colors.white,
                    false => Colors.grey,
                  },
                ),
...
final class _SandstoneVolume extends StatelessWidget {
  const _SandstoneVolume();
          ...
          SizedBox(
            ...
            child: SliderTheme(
              data: SliderTheme.of(context).copyWith(
                ...
                thumbShape: switch (state.volume.isFocused) {
